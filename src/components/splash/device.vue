...
<transition name="fade">
    <div class="c-deviceSplash" v-if="isNotPlaybackDevice">
        <div class="c-deviceSplash__inner">

            <!-- connect menu -->
            <div class="c-connectMenu">

              <img class="c-connectMenu__image" src="/static/images/connect_header.png" />
                ...
                <div class="c-connectMenu__item is-highlighted">
                    ...
                    <div class="c-connectMenu__itemIcon">
                        <div class="c-connectMenu__iconScreen"></div>
                        <div class="c-connectMenu__iconKeyboard"></div>
                    </div>
            ...
            <!-- message -->
            <i18n class="c-deviceSplash__message" path="splash.listeningOnAnotherDevice" tag="p">

              <span class="c-deviceSplash__deviceName" place="deviceName">{{ deviceName }}</span>
